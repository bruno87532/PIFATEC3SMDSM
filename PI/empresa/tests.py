...
class cadastra_dados_repetidos(TestCase):
    ...
    def test_dado_cnpj_repetido(self):
        ...
        self.assertTemplateNotUsed(resposta, 'cadastro_dois.html')
        self.assertTemplateUsed(resposta, 'cadastro_um.html')
        self.assertNotContains(resposta, 'Email já cadastrado', status_code=400)
        self.assertContains(resposta, 'CNPJ já cadastrado', status_code=400)
    def test_dado_email_repetido(self):
        ...
        self.assertTemplateNotUsed(resposta, 'cadastro_dois.html')
        self.assertTemplateUsed(resposta, 'cadastro_um.html')
        self.assertContains(resposta, 'Email já cadastrado', status_code=400)
        self.assertNotContains(resposta, 'CNPJ já cadastrado', status_code=400)
...
class cadastra_dados_errado_etapa_3_cadastro(TestCase):
    ...
    def test_errado_etapa_3_cpf(self):
        ...
        self.assertNotContains(resposta, 'Nome do representante inválido', status_code=400)
    def test_errado_etapa_3_nome_representante(self):
        ...
        self.assertNotContains(resposta, 'Telefone do representante inválido', status_code=400)
        self.assertContains(resposta, 'Nome do representante inválido', status_code=400)
