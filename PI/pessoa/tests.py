...
class cadatra_dados_errado_pessoa(TestCase):
    ...
    def test_cadastro_cpf_invalido(self):
        ...
        self.assertContains(resposta, 'CPF inválido', status_code=400)
        self.assertNotContains(resposta, 'Nome inválido', status_code=400)
        self.assertNotContains(resposta, 'É necessário ser maior de idade', status_code=400)
        self.assertNotContains(resposta, 'Senha inválida', status_code=400)
        self.assertNotContains(resposta, 'Número de telefone inválido', status_code=400)
    def test_cadastro_nome_invalido(self):
        ...
        self.assertTemplateNotUsed(resposta, 'login.html')
        self.assertTemplateUsed(resposta, 'cadastro.html')
        self.assertNotContains(resposta, 'CPF inválido', status_code=400)
        self.assertContains(resposta, 'Nome inválido', status_code=400)
        self.assertNotContains(resposta, 'É necessário ser maior de idade', status_code=400)
        self.assertNotContains(resposta, 'Senha inválida', status_code=400)
        self.assertNotContains(resposta, 'Número de telefone inválido', status_code=400)
    def test_cadastro_data_nascimento_invalida(self):
        ...
        self.assertNotContains(resposta, 'CPF inválido', status_code=400)
        self.assertNotContains(resposta, 'Nome inválido', status_code=400)
        self.assertContains(resposta, 'É necessário ser maior de idade', status_code=400)
        self.assertNotContains(resposta, 'Senha inválida', status_code=400)
        self.assertNotContains(resposta, 'Número de telefone inválido', status_code=400)
    def test_cadastro_telefone_invalido(self):
        ...
        self.assertNotContains(resposta, 'É necessário ser maior de idade', status_code=400)
        self.assertNotContains(resposta, 'Senha inválida', status_code=400)
        self.assertContains(resposta, 'Número de telefone inválido', status_code=400)
